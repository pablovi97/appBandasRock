import { Banda } from './../models/banda.models';
export const BANDAS: Banda[] = [
  {
    id: 1,
    nombre: 'The Rolling Stones',
    imagen: 'The Rolling Stones',
    anio: 1962,
    historia:
